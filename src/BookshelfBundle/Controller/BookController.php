...
class BookController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $books = $em->getRepository('BookshelfBundle:Book')->findAll();
    ...
    {
        $book = new Book();
        $form = $this->createForm('BookshelfBundle\Form\BookType', $book);
    ...
    {
        $deleteForm = $this->createDeleteForm($book);
        $editForm = $this->createForm('BookshelfBundle\Form\BookType', $book);
